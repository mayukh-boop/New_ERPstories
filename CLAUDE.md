...
| NE-JW-05 to NE-JW-06 | Job Work Payment | `job-work-payment-list.html`, `job-work-payment-edit.html` | `job_work_payments`, `job_work_credit_notes` |
...
├── job-work-payment-list.html          # Job Work Payment list — stat cards (Unpaid/Partially Paid/Paid), payable/paid/balance columns, Pay action disabled once fully paid
└── job-work-payment-edit.html          # Job Work Payment entry — Sections 1 & 4 (read-only), amount on received qty, credit note modal for balance qty, invoice/payment fields, PDF
```
